...
9. Dimension reduction (PCA or SVG)
    ...
    2. ntlk US inaugural presidential speech word-frequency example
        ...
        - reduced-dimension occurrenct matrices
    3. d3 visualizations of occurence matrices
...
11. (10 min) sentiment analysis to gage chatroom "mood"
...
Example Material, much of which will be incorporated into this tutorial as-is
