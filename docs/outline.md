...
2. (15 min) what is natural language processing 
    ...
    2. Story about the genesis of _information theory_ and introduction to concepts Applicable to NLP:
        ...
        * encryption
        * channel capacity
3. (15 min) why is natural language processing useful and fun 
...
5. (15 min) Tools and techniques for identifying "style" or "context"
...
8.  (20 min) Frequency analysis of US President inaugural speeches ()
...
9. (15 min) Dimension reduction (PCA or SVG)
...
10. (15 min) Jargon and typo consolidation
     ...
     - example usages o
11. (15 min) Parsing structured data to create small , context-specific databases of knowledge for use in NLP information extraction from unstructured text
...
12. (15 min) Natural language processing of search queries
...
12. (15 min) sentiment analysis to gage chat room "mood"
